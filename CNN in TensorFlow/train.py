...
## Preprocessing data
# All image will be rescale by 1.0/255.
...
#   - cat
#   - dog  
train_generator = train_datagen.flow_from_directory(train_dir, target_size=(64,64), class_mode='binary', batch_size=32)
test_generator = test_datagen.flow_from_directory(test_dir, target_size=(64,64), class_mode='binary', batch_size=32)
...
history = model.fit_generator(train_generator, validation_data=test_generator, steps_per_epoch=100, callbacks=[callbacks], epochs=20, validation_steps=50,verbose=2)
